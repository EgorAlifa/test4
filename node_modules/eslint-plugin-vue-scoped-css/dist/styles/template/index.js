...
class Template {
    ...
    static ofSelector(node) {
        return new Template(selector_1.default(node));
    }
    static ofParams(node) {
        return new Template(at_rule_params_1.default(node.paramsText.trim(), node.lang));
    }
    static ofDeclValue(nodeOrText, lang) {
        if (typeof nodeOrText === "string") {
            return new Template(decl_value_1.default(nodeOrText, lang || ""));
        }
        return new Template(decl_value_1.default(nodeOrText.value, nodeOrText.lang));
    }
    static ofNode(node) {
