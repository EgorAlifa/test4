...
@form-elem-border-size: .rem(1)[@return];
...
@form-elem-small-height: calc(@unit*4);
@form-elem-small-font-size: @font-size-smaller;

@form-elem-large-height: calc(@unit*6);
@form-elem-large-font-size: @font-size-larger;

@form-control-icon-width: calc(@unit*5);
...
@checkbox-size: calc(@unit*2.5);
@checkbox-small-size: calc(@unit*2);
...
@radio-size: calc(@unit*2.5);
@radio-small-size: calc(@unit*2);
...
@switch-width: calc(@unit*5);
@switch-height: calc(@unit*2.5);
@switch-small-width: calc(@unit*4);
@switch-small-height: calc(@unit*2);
...
.form-elem-small {
    ...
    min-height: @form-elem-small-height;
    line-height: @form-elem-line-height;
    padding-top: @p;
    padding-bottom: @p;
...
.form-elem-large {
    ...
    min-height: @form-elem-large-height;
    line-height: @form-elem-line-height;
    padding-top: @p;
    padding-bottom: @p;
...
.select {
    ...
    &.invalid,
    &:invalid {
        background-image: @select-invalid-icon;
        .hook-select-invalid();
    }

    &.valid {
        background-image: @select-valid-icon;
        .hook-select-valid();
    }
    ...
    &[disabled],
    &.disabled {
        background-image: @select-disabled-icon;
        .hook-select-disabled();
    }
...
.switch() {
    ...
    background-image: @switch-icon;
    background-position: left center;
    .border-round();

    &:checked {
        background-image: @switch-checked-icon;
    ...
    &.invalid {
        &:not(:checked) {
            background-image: @switch-invalid-icon;
        }
    ...
    &.valid {
        &:not(:checked) {
            background-image: @switch-valid-icon;
        }
...
.checkbox() {
    ...
    &:indeterminate {
        border-color: transparent;
        background-color: @color-primary;
        background-image: @checkbox-indeterminate-icon;
    }
