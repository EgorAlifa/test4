...
export interface ITransportExtraOptions {
    globalError?: boolean;
}
...
export type TransportRequestCancel = () => void;
...
export { AxiosInstance as HttpClient, AxiosError as HttpClientError } from 'axios';
