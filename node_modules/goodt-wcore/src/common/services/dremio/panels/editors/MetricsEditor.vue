<template>
    <div class="pad-l1">
        <div class="btn btn-primary w-100 p" @click="openNewMetricEditor">Добавить метрику</div>
        ...
        <div v-if="showNewMetricEditor" class="popup" style="z-index: 10; align-items: safe start">
            <div class="popup-dialog w-11-12 mar-top-l1">
                ...
                <div class="popup-dialog-footer pad-top-none text-right">
                    <button class="btn btn-ghost btn-small mar-right-3" @click="showNewMetricEditor = false">
                        Отмена
                    </button>
                    <button
