<template>
    <div class="pad-l1">
        <div class="p">
            <div class="form-label form-label-small">Столбец:</div>
        ...
        <div v-if="activeColumnNameExists" class="p">
            <div class="form-label form-label-small">Название поля:</div>
            <input
                class="input w-100"
                type="text"
        ...
        <div v-if="activeColumnSchema">
            <div>
                <i v-if="activeColumnSchema.meta" class="mdi mar-right-2" :class="activeColumnSchema.meta.icon" />
