    ...
    <popup :visible="show" @close="$emit('close')">
        <template v-slot:body>
            <div class="w-f3 mar-top-l1">
                <textarea
                    ...
                    style="height: 15rem"
                    placeholder="{dataset}" />
                <div v-if="importedDataset && importedDatasetError" class="alert alert-error mar-top-3">
        ...
        <template v-slot:footer>
            <div class="text-right">
                <button class="btn btn-ghost" :disabled="importedDatasetError" @click="importDataset">Сохранить</button>
            </div>
        </template>
    </popup>
</template>
...
<script>
import { Popup } from '@goodt-wcore/components';
