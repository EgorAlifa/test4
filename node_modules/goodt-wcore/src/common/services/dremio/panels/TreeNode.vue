                ...
                <div class="row row-collapse">
                    <div class="col col-auto col-vmid">
                        <div
                            ...
                            :title="`type: ${entity.containerType ? entity.containerType : entity.type}`">
...
const checkType = (typeToCheck, type) => String(typeToCheck).toLowerCase() === String(type).toLowerCase();
...
export default {
    ...
    computed: {
        ...
        icon() {
            ...
            if (checkType(containerType, CONTAINER_TYPE.SOURCE)) {
                return 'mdi mdi-cube-outline';
            }
            if (checkType(type, CATALOG_ENTITY_TYPE.DATASET)) {
                return 'mdi-database color-primary';
            }
            if (checkType(type, CATALOG_ENTITY_TYPE.CONTAINER)) {
        ...
        hasChildren() {
            return (
                ...
                checkType(this.entity.type, CATALOG_ENTITY_TYPE.CONTAINER)
            );
        }
    },
    methods: {
            ...
            this.getEntity(this.entity.path)
                .then((result) => {
                    ...
                    this.children = result.children.filter(
                        (el) =>
                            checkType(el.type, CATALOG_ENTITY_TYPE.DATASET) ||
                            checkType(el.type, CATALOG_ENTITY_TYPE.CONTAINER)
                    );
                })
        ...
        onNodeClick() {
            if (checkType(this.entity.type, CATALOG_ENTITY_TYPE.DATASET)) {
