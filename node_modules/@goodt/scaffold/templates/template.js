...
module.exports = class {
     ...
     * @return {boolean|Error}  true if success; else error
     */
    createWidget({ tplBindings, tplPath = this.tplPath, tplType: { elem: elemTplType, panel: panelTplType } = {} }) {
        ...
        const elemTplFilename = elemTplType ? `elem.${elemTplType}.vue` : `elem.vue`;
        this.buildWidgetFile(`${tplPath}/${elemTplFilename}`, `${this.widgetName}.vue`, tplBindings);
        this.buildWidgetFile(`${tplPath}/elem.types.d.ts`, `${typesPath}/${this.widgetName}.d.ts`, tplBindings);
        const panelTplFilename = panelTplType ? `panel.${panelTplType}.vue` : `panel.vue`;
        this.buildWidgetFile(`${tplPath}/${panelTplFilename}`, `${panelPath}/${panelName}.vue`, tplBindings);
        ...
        this.buildWidgetFile(`${tplPath}/index.types.d.ts`, `${typesPath}/index.d.ts`, tplBindings);
        this.buildWidgetFile(`${tplPath}/descriptor.js`, `descriptor.js`, tplBindings);
        this.buildWidgetFile(`${tplPath}/style.pcss`, `style.pcss`, tplBindings);
