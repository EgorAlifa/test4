...
__name(cancelThrottle, "cancelThrottle");
...
function AnimationStateManager() {
  ...
  return {
    ...
    animate: /* @__PURE__ */ __name(function animate(target, currentRect, toRect, duration) {
      if (duration) {
...
var PluginManager = {
  ...
  initializePlugins: /* @__PURE__ */ __name(function initializePlugins(sortable, el, defaults2, options) {
    plugins.forEach(function(plugin) {
...
var _detectNearestEmptySortable = /* @__PURE__ */ __name(function _detectNearestEmptySortable2(x, y) {
  var ret;
...
Sortable.prototype = {
  ...
  _delayedDragTouchMoveHandler: /* @__PURE__ */ __name(function _delayedDragTouchMoveHandler(e) {
  ...
  sort: /* @__PURE__ */ __name(function sort(order) {
...
function AutoScrollPlugin() {
  ...
  AutoScroll.prototype = {
    dragStarted: /* @__PURE__ */ __name(function dragStarted2(_ref) {
    ...
    dragOverCompleted: /* @__PURE__ */ __name(function dragOverCompleted(_ref2) {
      var originalEvent = _ref2.originalEvent;
      if (!this.options.dragOverBubble && !originalEvent.rootEl) {
        this._handleAutoScroll(originalEvent);
      }
    }, "dragOverCompleted"),
    drop: /* @__PURE__ */ __name(function drop3() {
      if (this.sortable.nativeDraggable) {
    ...
    nulling: /* @__PURE__ */ __name(function nulling() {
      touchEvt$1 = scrollRootEl = scrollEl = scrolling = pointerElemChangedInterval = lastAutoScrollX = lastAutoScrollY = null;
      autoScrolls.length = 0;
    }, "nulling"),
    _handleFallbackAutoScroll: /* @__PURE__ */ __name(function _handleFallbackAutoScroll(evt) {
      this._handleAutoScroll(evt, true);
    }, "_handleFallbackAutoScroll"),
    _handleAutoScroll: /* @__PURE__ */ __name(function _handleAutoScroll(evt, fallback) {
      var _this = this;
...
__name(AutoScrollPlugin, "AutoScrollPlugin");
...
__name(clearPointerElemChangedInterval, "clearPointerElemChangedInterval");
...
function SwapPlugin() {
  ...
  __name(Swap, "Swap");
  Swap.prototype = {
    dragStart: /* @__PURE__ */ __name(function dragStart2(_ref) {
      var dragEl2 = _ref.dragEl;
      lastSwapEl = dragEl2;
    }, "dragStart"),
    dragOverValid: /* @__PURE__ */ __name(function dragOverValid(_ref2) {
    ...
    drop: /* @__PURE__ */ __name(function drop3(_ref3) {
  ...
  return _extends(Swap, {
    pluginName: "swap",
    eventProperties: /* @__PURE__ */ __name(function eventProperties() {
      return {
        swapItem: lastSwapEl
      };
    }, "eventProperties")
...
function MultiDragPlugin() {
  ...
  __name(MultiDrag, "MultiDrag");
  MultiDrag.prototype = {
    multiDragKeyDown: false,
    isMultiDrag: false,
    delayStartGlobal: /* @__PURE__ */ __name(function delayStartGlobal(_ref) {
      var dragged = _ref.dragEl;
      dragEl$1 = dragged;
    }, "delayStartGlobal"),
    delayEnded: /* @__PURE__ */ __name(function delayEnded() {
      this.isMultiDrag = ~multiDragElements.indexOf(dragEl$1);
    }, "delayEnded"),
    setupClone: /* @__PURE__ */ __name(function setupClone(_ref2) {
    ...
    clone: /* @__PURE__ */ __name(function clone2(_ref3) {
    ...
    showClone: /* @__PURE__ */ __name(function showClone(_ref4) {
    ...
    hideClone: /* @__PURE__ */ __name(function hideClone(_ref5) {
      var _this = this;
    ...
    dragStartGlobal: /* @__PURE__ */ __name(function dragStartGlobal(_ref6) {
    ...
    dragStarted: /* @__PURE__ */ __name(function dragStarted2(_ref7) {
      var _this2 = this;
    ...
    dragOver: /* @__PURE__ */ __name(function dragOver(_ref8) {
    ...
    revert: /* @__PURE__ */ __name(function revert(_ref9) {
    ...
    dragOverCompleted: /* @__PURE__ */ __name(function dragOverCompleted(_ref10) {
    ...
    dragOverAnimationCapture: /* @__PURE__ */ __name(function dragOverAnimationCapture(_ref11) {
    ...
    dragOverAnimationComplete: /* @__PURE__ */ __name(function dragOverAnimationComplete() {
      if (folding) {
        folding = false;
        removeMultiDragElements();
      }
    }, "dragOverAnimationComplete"),
    drop: /* @__PURE__ */ __name(function drop3(_ref12) {
    ...
    nullingGlobal: /* @__PURE__ */ __name(function nullingGlobal() {
      this.isMultiDrag = dragStarted = false;
      multiDragClones.length = 0;
    }, "nullingGlobal"),
    destroyGlobal: /* @__PURE__ */ __name(function destroyGlobal() {
      this._deselectMultiDrag();
    ...
    _deselectMultiDrag: /* @__PURE__ */ __name(function _deselectMultiDrag(evt) {
    ...
    _checkKeyDown: /* @__PURE__ */ __name(function _checkKeyDown(evt) {
      if (evt.key === this.options.multiDragKey) {
        this.multiDragKeyDown = true;
      }
    }, "_checkKeyDown"),
    _checkKeyUp: /* @__PURE__ */ __name(function _checkKeyUp(evt) {
      if (evt.key === this.options.multiDragKey) {
  ...
  return _extends(MultiDrag, {
    ...
    utils: {
      select: /* @__PURE__ */ __name(function select(el) {
      ...
      deselect: /* @__PURE__ */ __name(function deselect(el) {
    ...
    optionListeners: {
      multiDragKey: /* @__PURE__ */ __name(function multiDragKey(key) {
        key = key.toLowerCase();
        if (key === "ctrl") {
          key = "Control";
...
__name(MultiDragPlugin, "MultiDragPlugin");
...
__name(insertMultiDragElements, "insertMultiDragElements");
...
__name(insertMultiDragClones, "insertMultiDragClones");
...
__name(removeMultiDragElements, "removeMultiDragElements");
 ...
 * @license MIT
 */
//# sourceMappingURL=chunk-WP6K4CDC.js.map
