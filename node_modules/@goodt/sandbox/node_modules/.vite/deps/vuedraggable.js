...
function cached(fn) {
  ...
  return /* @__PURE__ */ __name(function cachedFn(str) {
    const hit = cache[str];
...
__name(insertNodeAt, "insertNodeAt");
...
__name(buildAttribute, "buildAttribute");
function computeVmIndex(vnodes, element) {
  return vnodes.map((elt) => elt.elm).indexOf(element);
}
__name(computeVmIndex, "computeVmIndex");
...
__name(computeIndexes, "computeIndexes");
...
__name(delegateAndEmit, "delegateAndEmit");
function isTransitionName(name) {
  return ["transition-group", "TransitionGroup"].includes(name);
}
__name(isTransitionName, "isTransitionName");
...
__name(computeChildrenAndOffsets, "computeChildrenAndOffsets");
function getComponentAttributes($attrs, componentData) {
  let attributes = null;
  const update = /* @__PURE__ */ __name((name, value) => {
...
__name(getComponentAttributes, "getComponentAttributes");
...
var draggableComponent = {
  ...
  methods: {
    ...
    spliceList() {
      const spliceList = /* @__PURE__ */ __name((list) => list.splice(...arguments), "spliceList");
      this.alterList(spliceList);
    },
    updatePosition(oldIndex, newIndex) {
      const updatePosition = /* @__PURE__ */ __name((list) => list.splice(newIndex, 0, list.splice(oldIndex, 1)[0]), "updatePosition");
...
// dep:vuedraggable
var vuedraggable_default2 = vuedraggable_default;
export {
  vuedraggable_default2 as default
};
