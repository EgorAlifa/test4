...
var DeleteSourceMapsPlugin = /** @class */ (function () {
    function DeleteSourceMapsPlugin(_a) {
        var _b = _a === void 0 ? { isServer: null, keepServerSourcemaps: null, silent: true } : _a, isServer = _b.isServer, keepServerSourcemaps = _b.keepServerSourcemaps, silent = _b.silent;
        this.isServer = false;
