<template>
    <ui-container>
        ...
        <div class="rules-hint">
            ...
            В условиях правил можно обращаться к любой переменной хранилища напрямую — не нужно заранее объявлять её в настройках виджета.
            Выберите тип поля <b>«ключ хранилища»</b> и введите имя переменной.
        </div>
    </ui-container>
</template>
<script>
