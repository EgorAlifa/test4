...
const AiPriorityHigh = 5;
const GroupOrderTypography = 2;
const GroupOrderStyle = 3;
const GroupOrderAppearance = 4;
const GroupOrderFill = 5;
const GroupOrderStroke = 6;
const GroupOrderEffects = 7;
...
export const aiMeta = {
    ...
    aiPriority: AiPriorityHigh,  // Very commonly used (1-5 scale)
    ...
    inlineEditing: {
        enabled: true,
        fields: ['html'],
        toolbars: ['bold', 'italic', 'underline', 'strikethrough', 'color', 'highlight', 'link'],
        toolbarPosition: 'top',
        showOn: 'focus',
...
export const varBindings = {
    ...
    groups: {
        ...
        typography: {
            ...
            icon: 'format-font',
            collapsed: true,
            order: GroupOrderTypography
        },
        style: {
            label: 'Оформление',
            icon: 'palette',
            collapsed: true,
            order: GroupOrderStyle
        },
        appearance: {
            label: 'Внешний вид',
            icon: 'eye',
            collapsed: true,
            order: GroupOrderAppearance
        },
        fill: {
            label: 'Заливка',
            icon: 'format-color-fill',
            collapsed: true,
            order: GroupOrderFill
        },
        stroke: {
            label: 'Обводка',
            icon: 'border-color',
            collapsed: true,
            order: GroupOrderStroke
        },
        effects: {
            label: 'Эффекты',
            icon: 'blur',
            collapsed: true,
            order: GroupOrderEffects
        }
    },
