...
const StrokeWidthMedium = 3;
const StrokeWidthThick = 4;
const StrokeWidthHeavy = 6;
const StrokeOpacityGhost = 0.5;
const StrokeOpacityFaint = 0.3;
...
export const strokeWidthPresets = [
    ...
    { name: 'thin', label: 'Тонкая', value: StrokeWidthThin },
    { name: 'medium', label: 'Средняя', value: StrokeWidthMedium },
    { name: 'thick', label: 'Толстая', value: StrokeWidthThick },
    { name: 'heavy', label: 'Жирная', value: StrokeWidthHeavy }
];
...
export const strokePresets = {
    ...
    thin: {
        ...
        props: { strokeWidth: StrokeWidthThin, strokeStyle: 'solid', strokeOpacity: 1 }
    },
    ...
    medium: {
        ...
        props: { strokeWidth: StrokeWidthMedium, strokeStyle: 'solid', strokeOpacity: 1 }
    },
    ...
    thick: {
        ...
        props: { strokeWidth: StrokeWidthThick, strokeStyle: 'solid', strokeOpacity: 1 }
    },
    heavy: {
        label: 'Жирная',
        description: 'Жирная обводка 6px',
        props: { strokeWidth: StrokeWidthHeavy, strokeStyle: 'solid', strokeOpacity: 1 }
    },
    ...
    dashedMedium: {
        ...
        props: { strokeWidth: StrokeWidthThin, strokeStyle: 'dashed', strokeDasharray: '8,4', strokeOpacity: 1 }
    },
    dashedLong: {
        label: 'Штрих длинный',
        description: 'Длинные штрихи',
        props: { strokeWidth: StrokeWidthThin, strokeStyle: 'dashed', strokeDasharray: '12,6', strokeOpacity: 1 }
    },
    ...
    dottedMedium: {
        ...
        props: { strokeWidth: StrokeWidthThin, strokeStyle: 'dotted', strokeOpacity: 1 }
    },
    ...
    frameMedium: {
        ...
        props: { strokeWidth: StrokeWidthThin, strokeStyle: 'solid', strokeColor: '#d1d5db', strokeOpacity: 1 }
    },
    frameAccent: {
        label: 'Рамка акцент',
        description: 'Рамка с акцентным цветом',
        props: { strokeWidth: StrokeWidthThin, strokeStyle: 'solid', strokeColor: 'var(--color-primary)', strokeOpacity: 1 }
    },
    frameError: {
        label: 'Рамка ошибка',
        description: 'Красная рамка для валидации',
        props: { strokeWidth: StrokeWidthThin, strokeStyle: 'solid', strokeColor: 'var(--color-red)', strokeOpacity: 1 }
    },
    ...
    doubleLine: {
        ...
        props: { strokeWidth: StrokeWidthMedium, strokeStyle: 'double', strokeOpacity: 1 }
    },
    dashDot: {
        label: 'Штрих-точка',
        description: 'Паттерн штрих-точка',
        props: { strokeWidth: StrokeWidthThin, strokeStyle: 'dashed', strokeDasharray: '8,4,2,4', strokeOpacity: 1 }
    },
    ...
    ghostThin: {
        ...
        props: { strokeWidth: 1, strokeStyle: 'solid', strokeOpacity: StrokeOpacityGhost }
    },
    ghostMedium: {
        label: 'Призрачная средняя',
        description: 'Полупрозрачная средняя',
        props: { strokeWidth: StrokeWidthThin, strokeStyle: 'solid', strokeOpacity: StrokeOpacityFaint }
    }
};
...
export function getStrokeStylePreset(styleName) {
    return strokeStylePresets.find(stroke => stroke.name === styleName) || null;
}
