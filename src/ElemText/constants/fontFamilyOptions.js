...
export const fontsByCategory = {
    system: fontFamilyOptions.filter(font => font.category === 'system'),
    'sans-serif': fontFamilyOptions.filter(font => font.category === 'sans-serif'),
    serif: fontFamilyOptions.filter(font => font.category === 'serif'),
    monospace: fontFamilyOptions.filter(font => font.category === 'monospace'),
    display: fontFamilyOptions.filter(font => font.category === 'display')
};
