        ...
        <ui-container>
            ...
            >
                <div class="radius-header">
                    <ui-checkbox v-model="isLinkCornersLinked" @change="handleLinkCorners">
                        Связать углы
                    </ui-checkbox>
                </div>
                <div v-if="isLinkCornersLinked" class="slider-with-input">
                    <input
                        type="range"
                        :value="radiusValue"
                        min="0"
...
export default {
    ...
    data() {
        return {
            ...
            strokeStylePresets: StrokeStylePresets,
    ...
    methods: {
        ...
        initCornerRadius() {
            ...
            if (radius && typeof radius === 'object' && radius.topLeft !== undefined) {
                this.isLinkCornersLinked = false;
                ...
                this.radiusValue = radius.size > 0 ? radius.size : 0;
        ...
        initStrokeWidth() {
            ...
            if (width != null) {
                if (typeof width === 'object' && width.size !== undefined) {
                    this.strokeWidthValue = width.size > 0 ? width.size : 0;
