...
export default {
    ...
    computed: {
        ...
        gradient() {
            return this.fill.gradient || DefaultGradient;
        },
        ...
        stops() {
            return this.gradient.stops || DefaultGradient.stops;
        },
    ...
    methods: {
        setType(type) {
            ...
            if (type !== 'solid' && this.fill.gradient == null) {
                updatedFill.gradient = { ...DefaultGradient };
            }
