...
export const descriptor = () => ({
    props: {
        ...
        shouldBeFixedFirstColumn: {
            type: Boolean,
            default: false,
            label: 'Закрепить первый столбец'
        },
        cssClass: {
            type: Array,
            default: ['bg-white']
        ...
        showSliceExport: {
            type: Boolean,
            default: true,
            label: 'Кнопка «Выгрузить срез данных»'
        },
        showUnlimitedExport: {
            type: Boolean,
            default: true,
            label: 'Кнопка «Выгрузить данные целиком»'
        },
        xlsxFilename: {
            type: String,
        ...
        paginationActiveButtonSettings: {
            type: Object,
            default: () => ({
        ...
        paginationInactiveButtonSettings: {
            type: Object,
            default: () => ({
