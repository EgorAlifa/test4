                ...
                <ui-collapse v-for="({ title }, i) in props.values" :key="i" class="mar-bot-3">
                    ...
                    <ui-metric-settings
                        ...
                        v-bind="{
                            ...
                            sortDataAliasOptions: [{ label: '-', value: '' }, ...metrics]
                        }"></ui-metric-settings>
                </ui-collapse>
            </ui-draggable>
...
import { VerticalAligns, createFont, createCellSettings, MetricType, CellSortTypes } from '../utils/constants';
        ...
        addValue() {
            ...
            values.push(
                createCellSettings({
                    ...
                    sortDataType: CellSortTypes.NUMBER
                })
            );
            propChanged('values');
        },
