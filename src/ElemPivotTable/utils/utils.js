...
import { ProjectDataProviderRepository } from '@goodt-common/data';
...
/**
 * @param {import('@goodt-common/data').IProjectDataProvider['id']} dataProviderId
 * @return {{ connectorUrl: string }}
 */
export const resolveReportConnectorMeta = (dataProviderId) => {
    const { connector: { url } } = ProjectDataProviderRepository.getById(dataProviderId) ?? ProjectDataProviderRepository.getDefault();
    return {
        connectorUrl: url
    }
}