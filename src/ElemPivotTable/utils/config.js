...
export const ConditionsOptions = [
    ...
    { label: ConditionOperatorSymbol[ConditionOperator.NOT_EQUALS], value: ConditionOperator.NOT_EQUALS }
];

export const ConditionCompareValueTypesOptions = [
    { label: 'Статическое значение', value: ConditionCompareValueType.STATIC },
    { label: 'Метрика/Измерение', value: ConditionCompareValueType.FIELD }
];

export const ConditionDataTypesOptions = [
    { label: 'Строка', value: ConditionDataType.STRING },
    { label: 'Число', value: ConditionDataType.NUMBER },
    { label: 'Дата', value: ConditionDataType.DATE }
];

export const ConditionLogicalOperatorOptions = [
    { label: 'AND', value: ConditionLogicalOperator.AND },
    { label: 'OR', value: ConditionLogicalOperator.OR }
];
